...
namespace concurrencpp::tests {
	...
	void test_thread_pool_executor_wait_all();
	void test_thread_pool_executor_timed_wait_all();
...
void concurrencpp::tests::test_thread_pool_executor_wait_all(){
	auto executor = concurrencpp::make_runtime()->thread_pool_executor();
	object_observer observer;
...
void concurrencpp::tests::test_thread_pool_executor_timed_wait_all(){
	auto executor = concurrencpp::make_runtime()->thread_pool_executor();
	object_observer observer;
...
void concurrencpp::tests::test_thread_pool_executor() {
	...
	tester.add_step("wait_all", test_thread_pool_executor_wait_all);
	tester.add_step("wait_all(ms)", test_thread_pool_executor_timed_wait_all);
