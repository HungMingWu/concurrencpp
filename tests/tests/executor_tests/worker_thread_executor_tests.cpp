...
namespace concurrencpp::tests {
	...
	void test_worker_thread_executor_wait_all();
	void test_worker_thread_executor_timed_wait_all();
...
void concurrencpp::tests::test_worker_thread_executor_wait_all(){
	auto executor = concurrencpp::make_runtime()->worker_thread_executor();
	object_observer observer;
...
void concurrencpp::tests::test_worker_thread_executor_timed_wait_all(){
	auto executor = concurrencpp::make_runtime()->worker_thread_executor();
	object_observer observer;
